...
This class implements directly the [Tree](treed-tree-tree.md) interface by chaining the nodes with [child](treed-tree-treechain.md#child) and [next](treed-tree-treechain.md#next)
properties:
...
<sub>[index](index.md) :black_small_square: [top](#treechain) :black_small_square: [Content](#content) :black_small_square: [TreeChain](#treechain)</sub>
...
<sub>[index](index.md) :black_small_square: [top](#treechain) :black_small_square: [Content](#content) :black_small_square: [Methods](#methods)</sub>
