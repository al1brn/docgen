...
- D : [depth](#depth)
- F : [FromFile](#fromfile) :black_small_square: [FromInspect](#frominspect) :black_small_square: [FromListItem](#fromlistitem) :black_small_square: [FromStatic](#fromstatic) :black_small_square: [find_key](#find_key) :black_small_square: [fromkeys](#fromkeys)
...
``` python
FromInspect(property_object, name=None, verbose=False)
```
