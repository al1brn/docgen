...
This class implements directly the [Tree](dogen-tree3-tree.md) interface by chaining the nodes with [child](dogen-tree3-treechain.md#child) and [next](dogen-tree3-treechain.md#next)
properties:
...
- **A** : [add](dogen-tree3-treechain.md#add) :black_small_square: [all_count](dogen-tree3-treechain.md#all_count) :black_small_square: [all_items](dogen-tree3-treechain.md#all_items) :black_small_square: [all_paths](dogen-tree3-treechain.md#all_paths) :black_small_square: [all_values](dogen-tree3-treechain.md#all_values)
- **C** : [child](dogen-tree3-treechain.md#child) :black_small_square: [count](dogen-tree3-treechain.md#count) :black_small_square: [create_path](dogen-tree3-treechain.md#create_path)
- **D** : [depth](dogen-tree3-treechain.md#depth) :black_small_square: [DOT](dogen-tree3-treechain.md#dot)
- **F** : [find](dogen-tree3-treechain.md#find) :black_small_square: [FromFile](dogen-tree3-treechain.md#fromfile) :black_small_square: [FromInspect](dogen-tree3-treechain.md#frominspect)
- **G** : [get](dogen-tree3-treechain.md#get) :black_small_square: [get_child](dogen-tree3-treechain.md#get_child)
- **I** : [is_top](dogen-tree3-treechain.md#is_top) :black_small_square: [items](dogen-tree3-treechain.md#items)
- **J** : [join_keys](dogen-tree3-treechain.md#join_keys)
- **K** : [keys](dogen-tree3-treechain.md#keys)
- **L** : [last_child](dogen-tree3-treechain.md#last_child)
- **N** : [new](dogen-tree3-treechain.md#new) :black_small_square: [new_paths](dogen-tree3-treechain.md#new_paths) :black_small_square: [next](dogen-tree3-treechain.md#next)
- **P** : [path](dogen-tree3-treechain.md#path)
- **S** : [SEP](dogen-tree3-treechain.md#sep) :black_small_square: [set_child](dogen-tree3-treechain.md#set_child) :black_small_square: [solve_path](dogen-tree3-treechain.md#solve_path) :black_small_square: [solve_to_missing](dogen-tree3-treechain.md#solve_to_missing) :black_small_square: [sort](dogen-tree3-treechain.md#sort)
- **T** : [top](dogen-tree3-treechain.md#top)
- **V** : [values](dogen-tree3-treechain.md#values)
