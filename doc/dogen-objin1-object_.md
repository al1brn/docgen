...
- **A** : [add](dogen-objin1-object_.md#add) :black_small_square: [all_count](dogen-objin1-object_.md#all_count) :black_small_square: [all_items](dogen-objin1-object_.md#all_items) :black_small_square: [all_paths](dogen-objin1-object_.md#all_paths) :black_small_square: [all_values](dogen-objin1-object_.md#all_values)
- **C** : [count](dogen-objin1-object_.md#count) :black_small_square: [create_path](dogen-objin1-object_.md#create_path)
- **D** : [depth](dogen-objin1-object_.md#depth) :black_small_square: [DOT](dogen-objin1-object_.md#dot)
- **F** : [find](dogen-objin1-object_.md#find) :black_small_square: [FromFile](dogen-objin1-object_.md#fromfile) :black_small_square: [FromInspect](dogen-objin1-object_.md#frominspect)
- **G** : [get](dogen-objin1-object_.md#get) :black_small_square: [get_child](dogen-objin1-object_.md#get_child) :black_small_square: [get_prop](dogen-objin1-object_.md#get_prop)
- **I** : [is_top](dogen-objin1-object_.md#is_top)
- **J** : [join_keys](dogen-objin1-object_.md#join_keys)
- **K** : [key](dogen-objin1-object_.md#key)
- **M** : [meta](dogen-objin1-object_.md#meta)
- **N** : [new](dogen-objin1-object_.md#new) :black_small_square: [new_paths](dogen-objin1-object_.md#new_paths)
- **O** : [obj_type](dogen-objin1-object_.md#obj_type)
- **P** : [parse_comment](dogen-objin1-object_.md#parse_comment) :black_small_square: [path](dogen-objin1-object_.md#path)
- **S** : [SEP](dogen-objin1-object_.md#sep) :black_small_square: [set_child](dogen-objin1-object_.md#set_child) :black_small_square: [solve_path](dogen-objin1-object_.md#solve_path) :black_small_square: [solve_to_missing](dogen-objin1-object_.md#solve_to_missing)
- **T** : [top](dogen-objin1-object_.md#top)
