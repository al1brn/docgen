...
- **G** : [get](classfunc_.md#get) :black_small_square: [get_child](classfunc_.md#get_child) :black_small_square: [get_prop](classfunc_.md#get_prop)
- **I** : [is_top](classfunc_.md#is_top)
- **J** : [join_keys](classfunc_.md#join_keys)
- **K** : [key](classfunc_.md#key)
- **M** : [meta](classfunc_.md#meta) :black_small_square: [move_to_parent](classfunc_.md#move_to_parent)
