...
Nodes are create by calling [new](pydoc-classsection.md#new) method.
...
> [!IMPORANT]
> This method calls the abstract method [remove_from_parent](pydoc-classsection.md#remove_from_parent) which must perform
...
Basically, this method call [new](pydoc-classsection.md#new) for each provided path.
...
The group is created by calling [new_sections_group](pydoc-classsection.md#new_sections_group).
...
> [!NOTE]
> Missing nodes in the path are created with method [create_path](pydoc-classsection.md#create_path)
