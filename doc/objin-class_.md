...
- **A** : [add](objin-class_.md#add) :black_small_square: [all_count](objin-class_.md#all_count) :black_small_square: [all_items](objin-class_.md#all_items) :black_small_square: [all_paths](objin-class_.md#all_paths) :black_small_square: [all_values](objin-class_.md#all_values)
- **C** : [count](objin-class_.md#count) :black_small_square: [create_path](objin-class_.md#create_path)
- **D** : [depth](objin-class_.md#depth) :black_small_square: [detach](objin-class_.md#detach) :black_small_square: [DOT](objin-class_.md#dot)
- **F** : [find](objin-class_.md#find) :black_small_square: [FromFile](objin-class_.md#fromfile) :black_small_square: [FromInspect](objin-class_.md#frominspect)
- **G** : [get](objin-class_.md#get) :black_small_square: [get_child](objin-class_.md#get_child) :black_small_square: [get_prop](objin-class_.md#get_prop)
- **I** : [is_top](objin-class_.md#is_top)
- **J** : [join_keys](objin-class_.md#join_keys)
- **K** : [key](objin-class_.md#key)
- **M** : [meta](objin-class_.md#meta) :black_small_square: [move_to_parent](objin-class_.md#move_to_parent)
- **N** : [new](objin-class_.md#new) :black_small_square: [new_paths](objin-class_.md#new_paths)
- **O** : [obj_type](objin-class_.md#obj_type)
- **P** : [parse_comment](objin-class_.md#parse_comment) :black_small_square: [path](objin-class_.md#path)
- **R** : [remove_from_parent](objin-class_.md#remove_from_parent)
- **S** : [SEP](objin-class_.md#sep) :black_small_square: [set_child](objin-class_.md#set_child) :black_small_square: [solve_path](objin-class_.md#solve_path) :black_small_square: [solve_to_missing](objin-class_.md#solve_to_missing)
- **T** : [top](objin-class_.md#top)
