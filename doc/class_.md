...
- **N** : [new](class_.md#new) :black_small_square: [new_paths](class_.md#new_paths)
- **O** : [obj_type](class_.md#obj_type)
- **P** : [parse_comment](class_.md#parse_comment) :black_small_square: [path](class_.md#path)
- **R** : [remove_from_parent](class_.md#remove_from_parent)
- **S** : [SEP](class_.md#sep) :black_small_square: [set_child](class_.md#set_child) :black_small_square: [solve_path](class_.md#solve_path) :black_small_square: [solve_to_missing](class_.md#solve_to_missing)
- **T** : [top](class_.md#top)
...
> <small>TYPE</small>: **NoneType**<br> <small>DEFAULT</small>: **None**
...
> <small>TYPE</small>: **str**<br> <small>DEFAULT</small>: **class**
