...
- **A** : [add](tree3-treelist.md#add) :black_small_square: [all_count](tree3-treelist.md#all_count) :black_small_square: [all_items](tree3-treelist.md#all_items) :black_small_square: [all_paths](tree3-treelist.md#all_paths) :black_small_square: [all_values](tree3-treelist.md#all_values)
- **C** : [count](tree3-treelist.md#count) :black_small_square: [create_path](tree3-treelist.md#create_path)
- **D** : [depth](tree3-treelist.md#depth) :black_small_square: [DOT](tree3-treelist.md#dot)
- **F** : [find](tree3-treelist.md#find) :black_small_square: [FromFile](tree3-treelist.md#fromfile) :black_small_square: [FromInspect](tree3-treelist.md#frominspect)
- **G** : [get](tree3-treelist.md#get) :black_small_square: [get_child](tree3-treelist.md#get_child)
- **I** : [is_top](tree3-treelist.md#is_top) :black_small_square: [items](tree3-treelist.md#items)
- **J** : [join_keys](tree3-treelist.md#join_keys)
- **K** : [keys](tree3-treelist.md#keys)
- **N** : [new](tree3-treelist.md#new) :black_small_square: [new_paths](tree3-treelist.md#new_paths)
- **P** : [path](tree3-treelist.md#path)
- **S** : [SEP](tree3-treelist.md#sep) :black_small_square: [set_child](tree3-treelist.md#set_child) :black_small_square: [solve_path](tree3-treelist.md#solve_path) :black_small_square: [solve_to_missing](tree3-treelist.md#solve_to_missing)
- **T** : [top](tree3-treelist.md#top)
- **V** : [values](tree3-treelist.md#values)
